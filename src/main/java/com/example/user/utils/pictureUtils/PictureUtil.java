package com.example.user.utils.pictureUtils;
...
public class PictureUtil {
    ...
    //returns path
    public Mono<String> uploadUserProfilePict(FilePart part, Long userId) {
    ...
    private String getPath(Long userId, String extension)
    {
    ...
    private Mono<PutObjectResponse> uploadProfilePictureAtOnce(FilePart picture, Long userId, Long contentLength)
    {
