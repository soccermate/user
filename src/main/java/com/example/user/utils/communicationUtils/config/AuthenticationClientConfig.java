package com.example.user.utils.communicationUtils.config;
...
public class AuthenticationClientConfig {
    ...
    public ReactiveLoggerListener loggerListener(){
        return new DefaultReactiveLogger(Clock.systemUTC(), LoggerFactory.getLogger(AuthenticationClient.class.getName()));
    }
